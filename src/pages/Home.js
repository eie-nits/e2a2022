  ...
  <>
    ...
    <section className="container home-page">
        <div className="about">
          ...
          <p>We are expecting the peer-reviewed and selected papers of E2A 2022 conference to be published as proceedings with Springer in their prestigious &quot;Lecture Notes in Electrical Engineering&quot; series (https://www.springer.com/series/7818). This series is indexed by EI Compendex and Scopus databases.</p>
    ...
    <section className="keynote-speakers pt-4">
      ...
      <p className="mt-1 mb-4">Here are our Key note Speakers</p>
